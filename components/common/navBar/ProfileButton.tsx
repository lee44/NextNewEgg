...
const ProfileButton = () => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <Menu.Button className="flex items-center justify-center w-full gap-4 px-4 py-2 text-sm font-medium rounded-md hover:bg-white dark:text-white bg-opacity-20 hover:bg-opacity-30"
